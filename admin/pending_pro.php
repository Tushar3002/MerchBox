                          ...
                          <?php
                                    ...
                                    if(mysqli_num_rows($run) > 0){
                                        while($order_row = mysqli_fetch_array($run)){
                                            ...
                                            $order_status  = $order_row['order_status'];
                                             ...
                                             $pr_query = "SELECT * FROM product fp INNER JOIN categories cat ON fp.category = cat.id WHERE pid = $order_pro_id ";
                            ...
                            ?> 
                             <tr>
                               ...
                               <td><a href="edit_verify_pen.php?order_id=<?php echo $order_id; ?>"><button type="button" class="btn btn-primary btn-sm"> Edit</button></a></td>
                             </tr>   
                           <?php 
                                  }
                                }
