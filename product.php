<?php include('include/header.php');
  ...
  $query = "SELECT * FROM product Where status = 'publish' ORDER BY pid";
               ...
               <!----Product list-->
                ...
                <?php   
                  ...
                  if(isset($_GET['cat_id'])){
                      ...
                      $p_query = "SELECT * FROM product WHERE category=$catid ORDER BY pid DESC LIMIT $product_start,$required_pro";  
                      
                  } else if(isset($_POST['sear_submit'])){
                      $search = $_POST['search'];
                      $p_query = "SELECT * FROM product WHERE title LIKE '%$search%' ";
                  }
                else{
                    $p_query = "SELECT * FROM product WHERE status='publish' ORDER BY pid DESC LIMIT $product_start,$required_pro";
                  }
