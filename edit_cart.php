        ...
        if(isset($_SESSION['id'])){
          ...
          <div class="row">
            ...
            <div class="col-md-9 p-3">
                  <h5>Shopping Cart</h5>
                  <p class="text-right" style="margin-top:-30px"><a href="cart.php" class="btn btn-primary btn-sm"><i class="fas fa-shopping-cart"></i> Go to Cart</a>
                            ...
                            <?php
                                    ...
                                    if(mysqli_num_rows($run) > 0){
                                        while($cart_row = mysqli_fetch_array($run)){
                                            ...
                                            $pr_query = "SELECT * FROM product WHERE pid=$db_pro_id";
